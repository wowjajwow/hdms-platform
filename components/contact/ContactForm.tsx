      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        <label className="text-sm font-semibold text-slate-700 sm:col-span-2">문의 분야 <span className="text-[#0d52ce]">*</span>
          <select className={fieldClass} name="category" required defaultValue="">
            ...
            <option>MDC / 데이터센터</option><option>통합 인프라</option><option>환경 & 사회 & 지배구조</option><option>AI 인프라</option><option>NPU</option><option>GPU</option><option>AI Service</option><option>Public Cloud</option><option>기타 / 제휴</option>
          </select>
        </label>
